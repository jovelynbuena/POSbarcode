...
$pdf->Cell(60,5,'WEBSITE : www.cybarge.com',0,1,'C');
...
$pdf->SetX(7);
$pdf->SetFont('Arial', '', 6);
$pdf->Cell(75,5, 'No product Will Be Replaced Or Refunded If You Dont Have receipt With You', 0,2,'');


$pdf->SetX(7);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(25,5, 'You Can Refund within 7 Days Of Purchase', 0,2,'');
