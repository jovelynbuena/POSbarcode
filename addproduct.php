...
$supplier       =$_POST['txtselect_option'];
...
if (empty($barcode)) {
  ...
  if($insert->execute()){
    ...
    $_SESSION['status_code']="error";
        ...
        $_SESSION['status'] = "Only jpg, jepg, gif and png files can be uploaded";
        $_SESSION['status_code'] = "error";
...
<input type="number" min="1" step="any" class="form-control" placeholder="Enter stock" name="txtpurchaseprice" required>
</div>     

<div class="form-group">
<label >Sale Price</label>
<input type="number" min="1" step="any" class="form-control" placeholder="Enter Stock" name="txtsaleprice" required>
</div>     
